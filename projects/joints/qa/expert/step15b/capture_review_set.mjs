// Step 15B: the capture set a human expert reviews, taken from the `step15b-learner-clarity-complete` candidate build.
//
...
//
//   node qa/expert/step15b/capture_review_set.mjs
...
const PORT = 4192;
const OUT = "qa/visual/step15b_review";
...
writeFileSync(join(OUT, "captures.json"), JSON.stringify({ generatedAt: new Date().toISOString(), build: "step15b-learner-clarity-complete", viewport: "1280x800 unless the name says otherwise", consoleErrors: errors, captures }, null, 1));
